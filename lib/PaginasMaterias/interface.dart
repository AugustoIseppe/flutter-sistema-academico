...
class InterfaceHomemMaquina extends StatefulWidget {
  const InterfaceHomemMaquina({super.key});

  @override
  State<InterfaceHomemMaquina> createState() => InterfaceHomemMaquinaState();
}

class InterfaceHomemMaquinaState extends State<InterfaceHomemMaquina> {
